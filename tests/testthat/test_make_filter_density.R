...
datos <- tibble::tibble(Temporada, Madrigueras_con_actividad_aparente, Area_del_cuadrante)
datos_salida <- tibble::tibble(Temporada, densidad = Madrigueras_con_actividad_aparente)
